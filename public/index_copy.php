...
<html>
  ...
  <body id="home" style=" background-color: black; ">
	 ...
	 <form id="place_form" name="place_form"   method="GET" action="goto_copy.php" class="col-xs-8 col-xs-offset-2">
			...
			<div class="row">
				<div class="col-xs-9 col-xs-offset-1 col-sm-6 col-sm-offset-3">
					...
					<section >
						<div style = " text-align: center; font-family: 'Graduate', cursive;"><span style=" color: white; font-size:large; text-shadow: black 0.1em 0.1em 0.2em ;">TO</span></div>
	...
	<div class="row">
		<button type="submit" id="go" class="btn btn-danger col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4" style ="margin-top:3em; font-family: 'Graduate', cursive;" >GO</button>
	</div>
	</section>
	...
	<form id="time_form" name="time_form"   method="GET" action="goto_copy.php">							
						...
						<button type="button" class="btn btn-default res toggle-left"  style="color:white ;padding-right: 14px;width: 100%;; background-color:#B0312A; font-family: 'Graduate', cursive; border: 0px; padding-bottom: 1.6em; padding-top: 1.5em;padding-top: 1.5em;">BACK</button>
			</form>
...
mySlidebars.toggle('left');
    ...
    <script>
		...
		// alert( "http://" + document.domain + "/goto_copy.php" + "?" + user_input ); 
			window.location.href = "http://" + document.domain + "/goto_copy.php" + "?" + user_input ; 
			// window.location.href =  "http://localhost:8080/goto_copy.php" + "?" + user_input ; 
